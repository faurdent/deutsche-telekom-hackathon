...
function getCartesianRange(props, axis) {
  ...
  const padding3 = getPadding(props);
  if (vertical) {
    return [props.height - padding3.bottom, padding3.top];
  }
  return [padding3.left, props.width - padding3.right];
}
...
var VictoryClipContainer = class extends import_react25.default.Component {
  constructor(props) {
    super(props);
    this.clipId = !(0, import_isObject2.default)(props) || props.clipId === void 0 ? (0, import_uniqueId3.default)("victory-clip-") : props.clipId;
  }
...
var getCalculatedValues2 = (props) => {
  ...
  const padding3 = helpers_exports.getPadding(props);
  ...
  const getPadding3 = () => {
    if (props.padding === void 0) {
      const child = Array.isArray(props.children) ? props.children.find((c2) => {
        return (0, import_isObject3.default)(c2.props) && c2.props.padding !== void 0;
      }) : props.children;
