...
from utils import get_sql_answer, setup_databases, get_dataset_name, add_dataset, csv_to_sql, write_new_row, STORAGE_PATH
...
async def get_analytics(
    ...
    return await get_sql_answer(text, db_name), []
